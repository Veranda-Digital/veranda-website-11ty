---
title: Open Invitation for Testers
...
heroImage: '/assets/news/invite-to-beta-hero.png'
...
<div class="bg-slate pt-12 pb-3 ztablet:pt-20">
    <div data-aos-offset="0" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400" data-aos-once="true" class="m-auto w-80vw max-w-5xl">
        ...
        <h4 class="pt-6 pb-4 text-left font-sansmd text-lg font-medium leading-[1.2] tracking-tight text-brightgreen ztablet:text-lg">How to Participate</h4>
        <div class="pb-10 text-press text-white text-opacity-80 ztablet:text-left ztablet:text-press">
            Interested participants are invited to contact us at
            <a href="mailto:beta@getveranda.com" class="text-brightgreen underline">beta@getveranda.com</a>
            to learn more about our beta opportunities.
        </div>
    </div>
</div>
